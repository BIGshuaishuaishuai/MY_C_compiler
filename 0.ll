...
temp:
  ...
  %a5 = load i64, i64* %a
  %add_2 = add i64 %a5, i64 1
  store i64 %add_2, i64* %a
  %b6 = load i64, i64* %b
  %sub_3 = sub i64 %b6, i64 1
  store i64 %sub_3, i64* %b
  %d = alloca i64
  %a7 = load i64, i64* %a
  %shr_4 = ashr i64 %a7, i64 2
  store i64 %shr_4, i64* %d
  %b8 = load i64, i64* %b
  %shl_5 = shl i64 %b8, i64 2
  store i64 %shl_5, i64* %d
  %a9 = load i64, i64* %a
  %add_6 = add i64 %a9, i64 6
  ret i64 %add_6
}
